...
<body>
    ...
    $roombook = \App\Models\Roombook::find($pid);
    ...
    $Fname = $roombook->FName;
    $lname = $roombook->LName;
    $email = $roombook->Email;
    $National = $roombook->National;
    $country = $roombook->Country;
    $phone = $roombook->Phone;
    $room_type = $roombook->TRoom;
    $Bed_type = $roombook->Bed;
    $meal_type = $roombook->Meal;
    $cin_date = $roombook->Cin;
    $cout_date = $roombook->Cout;
    $nodays = $roombook->Nodays;
